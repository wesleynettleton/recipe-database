...
function BuildRecipePageComponent() {
  ...
  // Compliance tag state (used by the strict menu compliance tester)
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label className="flex items-center space-x-2 text-sm text-black">
                  <input
                    ...
                    onChange={(e) =>
                      setComplianceTags((p) => ({ ...p, isStarchyCookedInFatOil: e.target.checked }))
                    }
                  />
                ...
                <label className="flex items-center space-x-2 text-sm text-black">
                  <input
                    ...
                    onChange={(e) =>
                      setComplianceTags((p) => ({ ...p, isBreadNoAddedFatOil: e.target.checked }))
                    }
                  />
                ...
                <label className="flex items-center space-x-2 text-sm text-black">
                  <input
                    ...
                    onChange={(e) =>
                      setComplianceTags((p) => ({ ...p, isFruitDessert50Plus: e.target.checked }))
                    }
                  />
              ...
              <div className="grid grid-cols-1 gap-3 mt-4">
                <div>
                  <label className="block text-sm font-medium text-black">
                    Starchy varieties (comma-separated)
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-black">
                    Fruit varieties (comma-separated)
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-black">
                    Vegetable varieties (comma-separated)
                  </label>
                  <input
                    type="text"
